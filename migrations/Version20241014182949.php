 ...
 */
final class Version20241014182949 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `user` (_id_user VARCHAR(255) NOT NULL, name_user VARCHAR(255) DEFAULT NULL, email VARCHAR(255) NOT NULL, image_link VARCHAR(255) DEFAULT NULL, role VARCHAR(255) DEFAULT NULL, adress VARCHAR(255) DEFAULT NULL, contract VARCHAR(255) DEFAULT NULL, mdp VARCHAR(255) NOT NULL, infos_user VARCHAR(255) DEFAULT NULL, PRIMARY KEY(_id_user)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    }
